	...
	<div class="menu2">
			...
			<nav class="nav2">
				<ul>
					...
					<li><a href="http://api.whatsapp.com/send?1=pt_BR&phone=5599999999999">CONTATO</a></li>
					<li><a href="../forms.html">QUEM SOMOS</a></li>
				</ul>
			</nav>

			<button class="btn2"><a href="forms.html"><p>LOGIN</p></a></button>
		</div>
		<br><br><br><br><br><br>
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		<h4 class="card-title2">Carrinho</h4>
